...
public class TCLoadMarathonMatches extends TCLoadTCSRedshift {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getLong("project_stat_id") != DELETED_PROJECT_STATUS) {
                    ...
                    update.setTimestamp(9, rs.getTimestamp("submitby_date"));
                    ...
                    if (retVal == 0) {
                        ...
                        insert.setTimestamp(10, rs.getTimestamp("submitby_date"));
