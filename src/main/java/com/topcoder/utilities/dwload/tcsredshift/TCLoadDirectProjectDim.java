...
public class TCLoadDirectProjectDim extends TCLoadTCSRedshift {
    ...
    public void doLoadDirectProjectDim() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // project_create_date
                update.setTimestamp(4, rs.getTimestamp("create_date"));
                // project_modification_date
                update.setTimestamp(5, rs.getTimestamp("modify_date"));
                // billing_project_id
