...
public class TCLoadDRTracks extends TCLoadTCSRedshift {
    ...
    public void doLoadDRTracks() throws Exception {
        ...
        try {
            ...
            while (rsTracks.next()) {
                ...
                update.setTimestamp(6, rsTracks.getTimestamp("track_start_date"));
                update.setTimestamp(7, rsTracks.getTimestamp("track_end_date"));
                ...
                if (retVal == 0) {
                    ...
                    insert.setTimestamp(7, rsTracks.getTimestamp("track_start_date"));
                    insert.setTimestamp(8, rsTracks.getTimestamp("track_end_date"));
