...
public class TCLoadDRTrackPoints extends TCLoadTCSRedshift {
        ...
        try {
            ...
            if (tracksFound) {
                ...
                while (rsPoints.next()) {
                    ...
                    insert.setTimestamp(j++, rsPoints.getTimestamp("application_date"));
                    insert.setTimestamp(j++, rsPoints.getTimestamp("award_date"));
